...
static const char * profile_code[12][6] = {
	...
	{ NULL, "nfgu", "ninf", "nbal", "Nplh", "Uwar" }, /* not used by RoC */
...
// New Battlenet
extern int account_set_channel(t_account * account, char const * val) { return account_set_strattr(account, "BNET\\channel", val); }
extern char const * account_get_channel(t_account * account) { return account_get_strattr(account, "BNET\\channel"); }

extern char const * account_get_class(t_account * account) { return account_get_strattr(account, "BNET\\user\\class"); }
extern char const * account_get_coin(t_account * account) { return account_get_strattr(account, "BNET\\total\\coin"); }
extern char const * account_get_level(t_account * account) { return account_get_strattr(account, "Record\\W3XP\\ffa\\level"); }
extern char const * account_get_lastgameplayed(t_account * account) { return account_get_strattr(account, "BNET\\lastgameplayed"); }
extern int account_set_auth_icon(t_account * account, char const * icon_name, int val) { char temp[256]; std::sprintf(temp, "profile\\i\\%.100s", icon_name); return account_set_boolattr(account, temp, val); }
extern int account_get_auth_icon(t_account * account, char const * icon_name) { char temp[256]; std::sprintf(temp, "profile\\i\\%.100s", icon_name); return account_get_boolattr(account, temp); }
