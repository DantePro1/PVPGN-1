...
extern char const * account_get_class(t_account * account);
extern char const * account_get_coin(t_account * account);
extern char const * account_get_level(t_account * account);
extern char const * account_get_lastgameplayed(t_account * account);
